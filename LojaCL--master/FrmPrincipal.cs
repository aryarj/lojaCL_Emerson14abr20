...
namespace LojaCL
{
    public partial class FrmPrincipal : Form
    {
        ...
        public void CarregadgvPripedido()
        {
            ...
            // SqlDataAdapter, usado para preencher a DataTable
            SqlDataAdapter da = new SqlDataAdapter(cmd);
            // Adiciona um dataTable carregado em memória
            DataTable cartao = new DataTable();
            da.Fill(cartao);
            // Fonte de dados do datagrid view
            dgvPripedido.DataSource = cartao;
            // Quando for criar um controle em tempo de execução, 
            //é importante atribuir um nome para ele e definir sua principais propriedades
        ...
        {
            cartao_venda usu = new cartao_venda();
            usu.Show();
        }
